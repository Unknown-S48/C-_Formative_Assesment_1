...
Display whether the student PASS or FAIL			-- Line 68
Rule: Average >= 50 = PASS							-- Line 57
Dispaly results in the format shown above			-- Line 60
*/
	...
	static void Main()
	{
		...
		for (int i = 0; i < 3; i++)
		{
			...
			do
			{
				...
				marks[i] = ReadMark($"Enter mark for Subject {i + 1}: ");
		...
		//Showing if the student Passed or Failed
